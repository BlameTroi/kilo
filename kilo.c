...
void editorDrawRows(struct abuf *ab) {
  ...
  for (y = 0; y < E.screenrows; y++) {
    ...
    abAppend(ab, "\x1b[K", 3);  // erase line //todo: combine with prior append
